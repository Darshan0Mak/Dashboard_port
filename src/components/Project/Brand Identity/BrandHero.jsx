...
export default function BrandHero({ project }) {
  return (
    ...
    >
      {/* Blue Ambient Glow */}
      <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-full max-w-4xl h-96 bg-amber-500/10 blur-[120px] pointer-events-none" />

      <div className="relative z-10 fade-in">
        <span className="px-4 py-1.5 rounded-full border border-amber-200 dark:border-amber-500/30 bg-amber-50 dark:bg-amber-500/10 text-amber-600 dark:text-amber-400 text-xs font-bold uppercase tracking-widest">
          {project.category}
        </span>
